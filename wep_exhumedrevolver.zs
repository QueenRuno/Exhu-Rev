...
class HDExhuRev:HDHandgun{
	...
	override string gethelptext(){
		...
		..WEPHELP_UNLOAD.." Remove empty rounds \(double-tap to slap the gun\)\n"
	...
	action void A_FireRevolver(){
		...
		let bbb=HDBulletActor.FireBullet(self,godscaliber?"HDB_45ACP":"HDB_45ACP",spread:1.,speedfactor:frandom(1.06,1.06));
		if(
